...
//  Word Scramble
//
//  Created by Yashraj jadhav on 12/01/23.
//
...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard isLongEnough(word: answer) else {
            wordError(title: "Word is too Short ", message: " Words Must be \(minWordLength) letters at least ")
                return
        }
        
        guard isNotWordToGuess(word: answer) else {
            wordError(title: " Incorect Word !! ", message: "Word must be diffrent thant word to guess ")
            return
        }
